...
namespace Asian.Series
{
    class AsianSeries
    {
        ...
        private static void InserirSeries()
        {
            ...
            AsianSeries novaSerie = new AsianSeries(Id: repositorio.ProximoId(),
        ...
        private static void AtualizarSeries()
        {
            ...
            AsianSeries atualizaSerie = new AsianSeries(Id: indiceSerie,
                                        genero: (Genero)entradaGenero,
                                        titulo: entradaTitulo,
                                        ano: entradaAno,
                                        descricao: entradaDescricao);
        ...
        {
            Console.WriteLine();
            Console.WriteLine("AsianSeriesOnline ao seu dispor!!!");
